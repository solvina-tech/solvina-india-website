...
export const footerNavigation = {
  expertise: [
    {
      label: "Integrated Steam & Power Systems",
      href: "/expertise/integrated-steam-power-systems/",
    },
    {
      label: "Dynamic Simulation & System Modelling",
      href: "/expertise/dynamic-simulation-system-modelling/",
    },
    {
      label: "Power Systems & Grid Compliance",
    ...
    {
      label: "Plant Control & Operability",
      href: "/expertise/plant-control-optimization/",
    },
    {
      label: "Protection & Power Quality",
      href: "/expertise/protection-coordination/",
    },
    {
      label: "Energy & Utility Optimization",
  ...
  industries: [
    ...
    {
      label: "EPC & Project Organizations",
